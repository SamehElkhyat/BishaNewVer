...
import { FaCalendarAlt, FaTag, FaArrowRight, FaHome, FaFileAlt } from 'react-icons/fa';
    ...
    return (
      <div className={styles.notFound}>
        ...
        <Link href="/media-center/circulars" className={styles.backButton}>
          <FaArrowRight /> العودة إلى التعاميم
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.breadcrumbs}>
        ...
        <span>/</span>
        <Link href="/media-center/circulars" className={styles.breadcrumbLink}>
          <FaFileAlt />
          التعاميم
        </Link>
        <span>/</span>
        <span className={styles.breadcrumbCurrent}>تفاصيل التعميم</span>
      </div>
      ...
      <article className={styles.article}>
        <div className={styles.header}>
          {circularItem.category && <span className={styles.badge}>{circularItem.category}</span>}
          <h1 className={styles.title}>{circularItem.title}</h1>
        ...
        <div className={styles.body}>
          <p className={styles.content}>{circularItem.content}</p>
        </div>
      </article>
            ...
            {relatedCirculars.map((circular) => (
              <div key={circular.id} className={styles.relatedCard}>
                ...
                <div className={styles.relatedContent}>
                  <h3 className={styles.relatedCardTitle}>{circular.title}</h3>
